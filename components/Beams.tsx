...
declare global {
  namespace JSX {
    // Allow R3F JSX elements
    interface IntrinsicElements extends ThreeElements, MinimalThree {}
  }
}
...
const CanvasWrapper: FC<{ children: ReactNode; className?: string }> = ({ children, className }) => (
  <Canvas
    dpr={[1, 2]}
    frameloop="always"
...
// Uppercase aliases to avoid JSX intrinsic type noise in TS
const Group: any = 'group';
const AmbientLight: any = 'ambientLight';
const ColorEl: any = 'color';
const MeshEl: any = 'mesh';
...
const Beams: FC<BeamsProps> = ({
  ...
  return (
    <CanvasWrapper className="opacity-80">
      <Group rotation={[0, 0, degToRad(rotation)]}>
        <PlaneNoise ref={meshRef} material={beamMaterial} count={beamNumber} width={beamWidth} height={beamHeight} />
        <DirLight color={lightColor} position={[0, 3, 10]} />
      </Group>
      <AmbientLight intensity={1} />
      <ColorEl attach="background" args={[backgroundColor]} />
...
>(({ material, width, count, height }, ref) => {
  ...
  return <MeshEl ref={mesh} geometry={geometry} material={material} />;
});
