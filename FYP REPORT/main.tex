...
\subsubsection{Summary}
CYPHER Learning is big company learning system (LMS) for train many worker same time. It got one AI call CYPHER Agent. This AI look your job, your skill and what company want, then make personal lesson for you. It find what you weak and give right course fast. Good for big company because can track all worker and finish training easy.
...
\subsubsection{Summary}
Udacity sell expensive course call Nanodegree. It teach AI, cloud, data science and more. Big company like Google, Amazon help make the course so content very new and real. You do many hard project like real job and build good portfolio. Got real human mentor check your work and give feedback. After finish you ready for high pay tech job. But price very high.
...
\subsubsection{Summary}
CodeCombat is game that teach you code. You play fantasy game and write real Python or JavaScript to move hero and win fight. Very fun, especially for kid and total beginner. When you stuck, AI give hint fast. Level start easy then become hard. Good way to learn basic coding without boring.
...
A phase 2 development plan (FYP-2) is provided below.
To complete the final section, the following is a proposal to release main works and promote the platform:
\begin{enumerate}
\item Project-Based Assessment and AI Evaluation: Assemble the entire project system to real software problems. This includes requirements and specifications interface. The back end is concerned with the start, to check and assigning through progress and skills. Make submissions on AI checks of code, structure, methods, patterns, and choices and provide feedback on good parts, fixes, suggestions, and tips. It assists in connection of learning to actual work with pro feedback of skills.
\item Progress Tracking and Insights Module: Have a complete analytics configuration to journey views. Add dashboard, charts, percentages, time, skill graphs and compares. Back end monitors actions, speeds, spots and weak points or strengths. The insights that AI examines include mastered concepts, requires further discussion, speed, and feedback. It is in line with averages of similar folks. This provides information to make decisions, remain motivated, and spend time efficiently.
\item Content Development: Prepare complete content, assignments and templates of tracks such as web, data science, and mobile. Make learning methods interactive.
\item Testing and Validation: Conduct lots of tests such as unit, integration, user and performance to ensure reliability and ease of modules.
\item User Interface Enhancement: develop responsive, accessible interfaces with good design to be evaluated and provide insights, which are usable on all devices.
\item Performance Optimization: Add caching, database tuning and AI optimizations to have high, scalable performance, in particular, checks and insights.
\item Deployment and Monitoring: Make it live and add watching, logs and analytics to maintain and improve.
\end{enumerate}
...
\cleardoublepage
\bibliographystyle{IEEEtran}         % clean IEEE style
\bibliography{fypbib}                % your .bib file name
